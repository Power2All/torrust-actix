...
async fn main() -> std::io::Result<()>
{
    ...
    tokio::spawn(async move {
        loop {
            ...
            info!("[STATS TCP IPv4] Connect: {} - API: {} - Announce: {} - Scrape: {} - Failures: {} - NotFound: {}", stats.tcp4_connections_handled, stats.tcp4_api_handled, stats.tcp4_announces_handled, stats.tcp4_scrapes_handled, stats.tcp4_failure, stats.tcp4_not_found);
            info!("[STATS TCP IPv6] Connect: {} - API: {} - Announce: {} - Scrape: {} - Failures: {} - NotFound: {}", stats.tcp6_connections_handled, stats.tcp6_api_handled, stats.tcp6_announces_handled, stats.tcp6_scrapes_handled, stats.tcp6_failure, stats.tcp6_not_found);
