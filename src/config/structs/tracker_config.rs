...
pub struct TrackerConfig {
    ...
    #[serde(default = "crate::config::config::default_keys_cleanup_interval")]
    ...
    /// Maximum peers kept per torrent in each peer map (IPv4 seeds, IPv6 seeds, IPv4
    /// leechers, IPv6 leechers, RTC seeds, RTC leechers). When a map is full a stale peer
    /// is evicted to make room. `0` disables the limit, leaving memory bounded only by
    /// announce rate times `peers_timeout`.
    ...
    #[serde(default = "crate::config::config::default_prometheus_id")]
    pub prometheus_id: String,
    /// Cluster operating mode.
    #[serde(default = "crate::config::config::default_cluster")]
    pub cluster: ClusterMode,
    /// Wire encoding used for cluster WebSocket messages.
    #[serde(default = "crate::config::config::default_cluster_encoding")]
    ...
    #[serde(default = "crate::config::config::default_cluster_bind_address")]
    ...
    #[serde(default = "crate::config::config::default_rtc_peers_timeout")]
    ...
    #[serde(default = "crate::config::config::default_true")]
    ...
    #[serde(default = "crate::config::config::default_compression_level")]
