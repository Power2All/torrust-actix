 ...
 *
 * Usage:
 *   node seed.js [--tracker <url>] <file1> [<file2> ...]
 *
 * Options:
...
if (filePaths.length === 0) {
    console.error('Usage: node seed.js [--tracker <url>] [--name <name>] <file1> [<file2> ...]');
    process.exit(1);
}
...
async function main() {
    ...
    let result;
    try {
        result = await client.create(filePaths, { name: torrentName });
    } catch (e) {
